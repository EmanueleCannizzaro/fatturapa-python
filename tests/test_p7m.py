...
# This is the CA certificate used to validate ../data/test.txt.p7m
#
# The signature on the test file will expire (next expiration date: May  6 23:59:59 2024 GMT)
#
# To refresh it:
#
# 1. Sign ../data/test.txt with a CAdES envelope
# 2. Extract the signature:
#      openssl smime -verify -in ../data/test.txt.p7m -inform der -noverify -signer /tmp/cert.pem -out /dev/null
